...
public class RAGTest {
    ...
    public void testReadDocument(){
        ...
        Document document = FileSystemDocumentLoader.loadDocument("D:\\Desk\\java-ai-langchain4j-medical-main\\java-ai-langchain4j-medical-main\\rag文档\\测试.txt");
    ...
    public void testParsePDF(){
        Document document = FileSystemDocumentLoader.loadDocument(
                "D:\\Desk\\java-ai-langchain4j-medical-main\\java-ai-langchain4j-medical-main\\rag文档\\医院信息.pdf",
                new ApachePdfBoxDocumentParser()   //定义文档解析器
        );
    ...
    public void testReadDocumentAndStore(){
        ...
        Document document = FileSystemDocumentLoader.loadDocument("D:\\Desk\\java-ai-langchain4j-medical-main\\java-ai-langchain4j-medical-main\\rag文档\\人工智能.md");
